...
public class MenuPrincipal extends javax.swing.JFrame implements UndoableEditListener {
    ...
    public void buscarPatron(){
        int cantidadCoincidencias=logica.buscarPatron(textArea, textPatron.getText());
        textoCoincidencia.setText(Integer.toString(cantidadCoincidencias));
    }
    ...
    private void initComponents() {
        ...
        textPatron = new javax.swing.JTextField();
        jButton4 = new javax.swing.JButton();
        jLabel8 = new javax.swing.JLabel();
        textoCoincidencia = new javax.swing.JLabel();
        ...
        jLabel7.setText("Busqueda Patron:");
        desktopPane.add(jLabel7);
        jLabel7.setBounds(600, 20, 130, 17);
        desktopPane.add(textPatron);
        textPatron.setBounds(740, 20, 140, 27);
        ...
        jButton4.setBounds(890, 20, 120, 29);

        jLabel8.setText("Coincidencias:");
        desktopPane.add(jLabel8);
        jLabel8.setBounds(620, 60, 110, 17);
        desktopPane.add(textoCoincidencia);
        textoCoincidencia.setBounds(740, 60, 90, 17);
    ...
    private void contentMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_contentMenuItemActionPerformed
        JOptionPane.showMessageDialog(null, "Esta aplicacion fue creada bajo circunstancias muy extremas. Se creo en una laptop Dell Inspiron n9010\n"
                + "Ademas que se necesito de tres semanas para terminarlo. El dessarrollador es Juan Pablo Orizabal Gil, carné 201730318. Estudiante de\n "
                ...
                + "en el interior del pais. Curso el cuarto semestre de dicha ingenieria. 26-09-2018", "Datos del desarrollador", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        CargaArchivo carga = new CargaArchivo(this.archivo);
        carga.numerar(textArea, numeracion);
        Automata automata = new Automata(modeloLista, modeloLexemas, modeloTokens);
        automata.inicio(textArea.getText(), 0);
    ...
    private javax.swing.JTextField textPatron;
    private javax.swing.JLabel textoCoincidencia;
